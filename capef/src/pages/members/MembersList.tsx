...
import { useListMembers, getExportMembersUrl } from '@workspace/api-client-react';
import type { ListMembersCategory, ListMembersMemberType } from '@workspace/api-client-react';
...
export default function MembersList() {
  ...
  const { data, isLoading } = useListMembers(
    { page, search: search || undefined, category, memberType },
    {
      query: {
        queryKey: ['members', { page, search, category, memberType }],
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-xl border border-border shadow-sm overflow-hidden flex flex-col">
        {/* Filters */}
        <div className="p-4 border-b border-border bg-muted/10 grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-9 pr-4 py-2 rounded-md border border-input bg-background focus:ring-1 focus:ring-primary focus:border-primary outline-none transition-all"
            />
          </div>
          ...
          <select 
            ...
            className="w-full px-3 py-2 rounded-md border border-input bg-background focus:ring-1 focus:ring-primary focus:border-primary outline-none"
          >
